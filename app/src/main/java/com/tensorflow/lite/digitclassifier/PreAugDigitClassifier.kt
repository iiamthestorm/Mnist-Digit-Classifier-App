...
class PreAugDigitClassifier(private val context: Context) {
    ...
    private fun initializeInterpreter() {
        ...
        val model = loadModelFile(assetManager, "before_data_aug_mnist.tflite")
    ...
    companion object {
        private const val TAG = "PreAugDigitClassifier"
